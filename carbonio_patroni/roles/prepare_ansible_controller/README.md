...
This role prepares the Ansible controller before the component installation starts.
...
This role is executed before remote host validation and package installation.
